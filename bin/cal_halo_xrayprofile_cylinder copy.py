...
for mf in [13.0, 13.5, 14.0, 14.5, 15.0]:
    ...
    def cal_xraylum(k):
        ...
        for j in range(len(bins)-1):
            radmsk = msk_in_cylinder(np.array([df_part['part_xcoords'], df_part['part_ycoords'], df_part['part_zcoords']]).T, halo_cen, bins[j], bins[j+1], 6.25/2)
    ...
    for prop in props:
        ...
        savepath = f'{workpath}/xraylum_csvs_230508_{mf}_groups_radial_pkpc_cylinder'
